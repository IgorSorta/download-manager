defmodule DownloaManagerWeb.DownloadLiveComponent do
  use Phoenix.LiveComponent

  alias DownloaManager.Download
  ...
  defp state_text(@pending_state) do
    "Starting download request"
  end

  defp state_text(@processing_state) do
    "Generating file"
  end

  defp state_text(@ready_state) do
